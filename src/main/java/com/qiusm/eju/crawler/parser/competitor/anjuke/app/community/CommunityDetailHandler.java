...
public class CommunityDetailHandler extends CommunityPageListHandler {
    ...
    static {
        mappingKey.put("property_company", "data.community.extend.propertyCompany");
        mappingKey.put("property_money", "data.community.extend.propertyMoney");
        mappingKey.put("total_area", "data.community.extend.totalArea");
        mappingKey.put("total_house_hold_num", "data.community.extend.totalHouseHoldNum");
        mappingKey.put("developer", "data.community.extend.developer");
        mappingKey.put("plot_ratio", "data.community.extend.plotRatio");
        mappingKey.put("landscaping_ratio", "data.community.extend.landscapingRatio");
        mappingKey.put("parking", "data.community.extend.parking");
        mappingKey.put("completion_time", "data.community.extend.completionTime");
        mappingKey.put("address", "data.community.base.address");
    }
    ...
    protected void parser(RequestDto requestDto, ResponseDto responseDto) {
        ...
        // log.info("{}, {}", requestDto.getRequestParam(), result);
